...
gnuplot -e "set term png; set xtics rotate by 90 right;set boxwidth 0.5 absolute;set style fill solid border;set output '"$base".png';plot 'stat.txt' u 0:3:xtic(1) with boxes title 'Add line','' u 0:4:xtic(1) with boxes title 'Delete lines'"
rm fnn.sh
