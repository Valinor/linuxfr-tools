...
gnuplot -e "set term png; set xtics rotate by 90 right;set boxwidth 0.5 absolute;set style fill solid border;set output '"$base".png';plot 'stat.txt' u 0:3:xtic(2) with boxes title 'Lines added','' u 0:4:xtic(2) with boxes title 'Lines deleted'"
rm fnn.sh
